...
import { ArrowRight, Sparkles, Clock, TrendingUp, Star, Play, Check, Zap, X } from "lucide-react";
          ...
          >
            ...
            >
              ...
              <div className="absolute top-4 left-4 z-10 px-4 py-2 bg-black/50 backdrop-blur-sm rounded-full">
                <span className="text-white text-sm font-medium">SynaPitch Tutorial</span>
              </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-600">
                <span className="font-semibold text-slate-900">4.9/5</span> from 1,300+ reviews
              </span>
            </div>
            ...
            <div className="p-8 space-y-6">
              ...
              {activeStep >= 1 && (
                ...
                >
                  ...
                  {["Client needs web developer", "Prefers React & Node.js", "Budget: $3,000-$5,000"].map(
                    (insight, i) => (
                      <motion.div
                        key={i}
